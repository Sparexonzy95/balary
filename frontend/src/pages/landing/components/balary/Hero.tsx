...
import { DecryptingHeadline } from "@/components/balary/DecryptingHeadline";
    ...
    <section className="zl-hero relative mt-8 flex min-h-screen overflow-hidden bg-[#050505] px-5 py-24 text-white sm:mt-10 sm:px-8 sm:py-28 lg:mt-12 lg:px-12 lg:py-32">
      ...
      >
        <div className="relative z-10 max-w-[580px]">
          ...
          >
            ...
            <span className="block whitespace-nowrap">
              <DecryptingHeadline text="settled in USDM." />
            </span>
            <span className="block whitespace-nowrap">
              <DecryptingHeadline text="powered by Midnight." />
            </span>
          </motion.h1>
          ...
          >
            Balary locks public USDM 1:1, mints shielded zUSDM for confidential
            payroll, and lets employees redeem back to public USDM when settlement
            is needed.
          </motion.p>
        ...
        >
          ...
          <motion.img
            src={HERO_IMAGE}
            alt="Balary confidential USDM payroll infrastructure on Midnight"

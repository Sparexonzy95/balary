...
const STEPS = [
  {
    title: "Deposit public USDM",
    body: "The institution deposits USDM into the Balary Stablecoin Gateway, where it is locked as public 1:1 backing.",
    surface: "#111113",
    media: "#171719",
    image:
  ...
  {
    title: "Mint shielded zUSDM",
    body: "The Gateway mints an equal amount of shielded zUSDM to move payroll value into Midnight private state.",
    surface: "#141416",
    media: "#1A1A1D",
    image:
  ...
  {
    title: "HR approves salary",
    body: "HR privately approves the exact employee salary intent using secret-derived authority and blinded commitment data.",
    surface: "#101214",
    media: "#171A1D",
    image:
  ...
  {
    title: "Finance funds payroll",
    body: "Finance can fund only the exact HR-approved allocation, moving the dedicated shielded salary coin into the PayrollVault.",
    surface: "#151312",
    media: "#1B1815",
    image:
  ...
  },
  {
    ...
    body: "The employee proves entitlement with private claim material, Merkle membership, and a nullifier, then receives zUSDM.",
    surface: "#121416",
    media: "#181C1F",
    image:
      "https://res.cloudinary.com/dxmdwvmxl/image/upload/v1777032757/step_5_employee_request_xbwshc.png",
  ...
  {
    title: "Redeem to public USDM",
    body: "When public settlement is needed, zUSDM is burned and the Gateway releases the same amount of public USDM.",
    surface: "#131315",
    media: "#1B1B1E",
    image:
      ...
      <div className="mx-auto max-w-[1220px]">
        <div className="pb-10 text-left md:pb-14">
          ...
          >
            ...
            >
              From public USDM to private payroll,{" "}
              <span className="text-neutral-500">
                every step is enforced.
              </span>
            </motion.h2>
            ...
            >
              A clear path from public USDM backing to shielded zUSDM, private
              salary approval, exact Finance funding, employee claim, and redemption.
            </motion.p>
          </motion.div>
        </div>

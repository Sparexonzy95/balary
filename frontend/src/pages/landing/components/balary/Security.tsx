...
const FEATURES = [
  { title: "Salary allocations use blinded commitments instead of public employee-to-salary mappings", icon: Lock },
  { title: "Admin, HR, Finance, and employee authority is derived from private secrets", icon: KeyRound },
  { title: "Merkle membership proves entitlement without revealing the whole payroll", icon: Eye },
  { title: "Claim nullifiers prevent double claims while preserving private allocation data", icon: FileCheck2 },
  { title: "Gateway accounting enforces USDM locked = outstanding redeemable zUSDM", icon: Shield },
];
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 md:px-8">
        ...
        <div className="max-w-xl md:max-w-3xl">
          <SectionHeader
            eyebrow="Privacy by protocol design"
            title={
              <>
                Public settlement can stay verifiable.
                <span className="text-neutral-500">
                  {" "}Balary keeps salary relationships and claims private on Midnight.
                </span>
              </>
            }
          />
